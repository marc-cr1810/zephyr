...
public:
    ...
    {
        throw std::runtime_error("Object does not support negation");
    }
    ...
    {
        throw std::runtime_error("Object has no member '" + member_name + "'");
    }

    virtual auto set_member(const std::string& member_name, std::shared_ptr<object_t> value) -> void
    {
        throw std::runtime_error("Object does not support member assignment");
    }
    ...
    {
        throw std::runtime_error("Object has no method '" + method_name + "'");
    }

    // Container operations
    virtual auto contains(std::shared_ptr<object_t> item) -> bool
    {
        throw std::runtime_error("Object does not support containment check");
    }
};
